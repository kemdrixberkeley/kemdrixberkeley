...
- A fleet of eight specialised agents that run unattended: mail triage, research, web work, quality auditing.
- A deterministic auditor that reviews that fleet every night against its own rulebook and reports concrete failures. Prose rules are aspiration; machine checks are not.
- Web projects for service businesses on the Costa del Sol, built so search engines and AI assistants can actually read them.

**What I have learned doing it**

The interesting failure of autonomous agents is not that they crash. It is that they quietly skip the parts nobody measures, while still reporting success. Most of what I build now exists to close that gap.
